...
Sppd *tolatticemesh( TFace *tfc, int div )
{
  ...
  // 補正
  tfc_remL_internal_update( tfc, uvcorner, div, duv, dvec, DIFF_GEODIS );
...
// 測地線距離によるアップデート
//
void tfc_remL_internal_update( TFace* tfc, Vec2d* uvcorner, int div,
			       Vec2d* ouv, 
			       Vec* ovec, // 補正分のパラメータ，ベクトル
			       int type )
{
  // パラメータ化補正
  int cnt = 0;
...
double tfc_uv_isoparam_diff( TFace* tfc, int div, Vec2d* uvcorner,
